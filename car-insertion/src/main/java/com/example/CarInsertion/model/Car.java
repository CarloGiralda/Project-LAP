...
public class Car {
    ...
    public Car(String plateNum, Long year, PollutionLevel pollutionLevel, Fuel fuel, String brand, Long passengers, String model,
               Classification classification, Long carDoorNumber, Engine engine, Transmission transmission) {
        this.plateNum = plateNum;
        this.year = year;
        this.pollutionLevel = pollutionLevel;
        this.fuel = fuel;
    ...
    public boolean hasEmptyFields() {
        return getPlateNum() == null || getYear() == null || getPollutionLevel() == null || getFuel() == null || getBrand() == null ||
                getPassengers() == null || getModel() == null || getClassification() == null ||
                getCarDoorNumber() == null || getEngine() == null || getTransmission() == null || getImage() == null;
    }
}
